export const projectsData = [
  {
    ...
    images: [
      `${import.meta.env.BASE_URL}images/projects/sbir/main.png`
    ],
    features: [
    ...
    live: "#",
    demo: `${import.meta.env.BASE_URL}demos/sbir/video5410928684.mp4`
  },
  {
    id: 2,
    ...
    images: [
      `${import.meta.env.BASE_URL}images/projects/quant/main.png`,
      `${import.meta.env.BASE_URL}images/projects/quant/01_real_data_loading.png`,
      `${import.meta.env.BASE_URL}images/projects/quant/02_real_model_training.png`
    ],
    features: [
  ...
  },
  {
    ...
    images: [
      `${import.meta.env.BASE_URL}images/projects/mcq/main.png`
    ],
    features: [
    ...
    live: "#",
    demo: `${import.meta.env.BASE_URL}demos/mcq/video3410928684.mp4`
  },
  {
    id: 4,
    ...
    images: [
      `${import.meta.env.BASE_URL}images/projects/energy/main.png`
    ],
    features: [
    ...
    live: "#",
    downloadLink: `${import.meta.env.BASE_URL}pdfs/energy.pdf`
  },
  {
    id: 5,
    ...
    images: [
      `${import.meta.env.BASE_URL}images/projects/exchange/main.png`,
      `${import.meta.env.BASE_URL}images/projects/exchange/aud_timeseries.png`,
      `${import.meta.env.BASE_URL}images/projects/exchange/model_performance_history.png`
    ],
    features: [
  ...
  },
  {
    ...
    images: [
      `${import.meta.env.BASE_URL}images/projects/chat/main.png`
    ],
    features: [
  ...
  },
  {
    ...
    images: [
      `${import.meta.env.BASE_URL}images/projects/smh/main.jpg`,
      `${import.meta.env.BASE_URL}images/projects/smh/7a9cbc167cab008bd155839dcd7c608.jpg`,
      `${import.meta.env.BASE_URL}images/projects/smh/ebdf97e94b31549510e59cb95e2bd43.jpg`
    ],
    features: [
  ...
  },
  {
    ...
    images: [
      `${import.meta.env.BASE_URL}images/projects/web/main.png`
    ],
    features: [
